...
/**
 * A value type representing coordinates in a {@link BasicSpreadsheet}.
 */
public class Coord {
  ...
  /**
   * The constructor for a Coord, taking in two ints.
   * @param col an int representing a Coord's column
   * @param row an int representing a Coord's row
   */
